//! Shared helpers for parsing crossterm input events into nushell `Value`s.
//!
//! Used by both `input listen` (single-event capture) and `input stream`
//! (continuous capture as a `ListStream`).
...
#[derive(Clone)]
pub(super) struct EventTypeFilter {
    pub(super) listen_focus: bool,
    pub(super) listen_key: bool,
    pub(super) listen_mouse: bool,
    pub(super) listen_paste: bool,
    pub(super) listen_resize: bool,
}
...
impl EventTypeFilter {
    ...
    pub(super) fn all() -> EventTypeFilter {
        EventTypeFilter {
            listen_focus: true,
            listen_key: true,
            listen_mouse: true,
    ...
    pub(super) fn from_value(value: Value, head: Span) -> Result<EventTypeFilter, ShellError> {
    ...
    /// console state.
    pub(super) fn enable_events(&self, span: Span) -> Result<DeferredConsoleRestore, ShellError> {
...
pub(super) struct DeferredConsoleRestore {
